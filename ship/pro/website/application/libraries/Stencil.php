...
class Stencil {
	...
	protected $css    		= array();
	protected $js     		= array();
	protected $css_front	= array();
	protected $js_front		= array();
	...
	public function paint($page, $data = NULL)
	{
		...
		// $this->data['front_css']	= add_front_css($this->front_css);
		$this->data['meta']  		= add_meta($this->meta);
		$this->data['js']    		= add_js($this->js);
		$this->data['js_front']		= add_front_js($this->js_front);
	...
	public function css_front($css)
	{
		$this->css_front = array_merge($this->css_front, (array)$css_front);
	}
	...
	public function js_front($js_front)
	{
		$this->js_front = array_merge($this->js_front, (array)$js_front);
	}
